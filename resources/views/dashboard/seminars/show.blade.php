...
@section('container')
  <div class="container my-4">
    <div class="row justify-content-start mb-4">
      <div class="col">
        <a class="btn btn-success" href="/dashboard/seminars"><i class="bi bi-arrow-left-circle"></i> Kembali</a>
        <a class="btn btn-warning" href="/dashboard/seminars/{{ $seminar->slug }}/edit"><i class="bi bi-pencil-square"></i> Edit</a>
        <form action="/dashboard/seminars/{{ $seminar->slug }}" method="POST" class="d-inline">
          @method('delete')
          @csrf
          <button class="btn btn-danger" onclick="return confirm('Yakin ingin menhapus?')" title="Hapus seminar"><i class="bi bi-trash"></i> Hapus</button>
        </form>
      </div>
    </div>
